        ...
        <div className="rounded-t bg-white mb-0 px-6 py-3 shadow-sm z-10">
          <div className="text-center flex justify-between">
            ...
            <div className="flex space-x-3">
              <div className="mt-5">
                <Link
                  href={`/admin/property/edit-property?key=${property._id}`}
                >
                  <a className="text-[16px] bg-[#000] text-[#fff] font-semibold pl-4 pr-5 py-2 rounded-3xl ">
                    Edit Property
                  </a>
                </Link>
              </div>
              <div className="mt-5">
                <Link
                  href={`/admin/property/property-images?property=${property._id}`}
                >
                  <a className="text-[16px] bg-[#000] text-[#fff] font-semibold pl-4 pr-5 py-2 rounded-3xl ">
                    Manage Images
                  </a>
              ...
              <div className="mt-5">
                <Link
                  href={`/admin/property/floor-plans?property=${property._id}`}
                >
                  <a className="text-[16px] bg-[#000] text-[#fff] font-semibold pl-4 pr-5 py-2 rounded-3xl ">
                    Manage Floor Plans
                  </a>
