  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      <div className="flex flex-row w-screen items-center">
        <img src="/tinder.png" alt="Vercel Logo" className="h-10 ml-4" />
        <a className="ml-2 font-bold text-red-600 font-mono text-xl">Admin</a>
      </div>
      <main className="flex flex-row h-100 w-full flex-1  justify-between px-4">
        <div className="w-3/5 flex justify-center items-center h-full  hidden lg:block">
          <img src="/login.svg" alt="Vercel Logo" className="h-full" />
        </div>
        ...
        <div className="w-full lg:w-2/5 h-100 justify-center items-center flex  flex-col py-30">
          <div className="self-center">
            ...
            <div className="flex-row flex items-center justify-center mt-3">
              ...
              <a
                href="/signup"
                className="text-red-600 font-extralight text-xs ml-1"
              >
                Create an account
              </a>
            </div>
